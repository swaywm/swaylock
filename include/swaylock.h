...
struct swaylock_state {
	...
	/// these are non-owning handles, @eventloop manages their lifetimes
	...
	struct loop_timer *grace_timeout_timer;   // timer for grace period skip lock, if enabled
	...
	int failed_attempts;
	bool run_display, locked, grace_on;
